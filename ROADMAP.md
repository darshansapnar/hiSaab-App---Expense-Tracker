...
### Phase 8: Offline Sync Queue & Notifications
*   **Goal:** Ensure resilience when offline and alert users of updates.
*   **Deliverables:**
    *   Zustand-based Offline action store queueing failed writes.
    *   NetInfo event hooks initiating background uploads once network restores.
